...
tf.flags.DEFINE_float("l2_reg_lambda", 0.15, "L2 regularization lambda (default: 0.0)")
...
if dataset_name == 'mrpolarity':
    ...
    vocab_processor = learn.preprocessing.VocabularyProcessor(2000) # for 20 news group
